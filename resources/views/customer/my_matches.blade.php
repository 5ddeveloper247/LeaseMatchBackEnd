    ...
    <div class="contain-fluid">
        ...
        <div class="main_row flex_row">
            ...
            <?php
                        ...
                        $image = isset($property->propertyImages[0]->path) ?url('/').$property->propertyImages[0]->path : asset('assets/images/property_default.jpg');
                    ?>
            ...
            <div class="col">
                <div class="item_blk">
                    ...
                    <div class="image">
                        ...
                        <div class="overlay">
                            <ul class="social_links">
                                <li class="view_property_detail pointer" data-id="{{$property->id}}"
                    ...
                    <div class="txt">
                        <h5 class="title">
                            <a class="view_property_detail pointer" data-id="{{$property->id}}"
                                title="View Property Detail">{{@$property->propertyDetail->property_type}}
